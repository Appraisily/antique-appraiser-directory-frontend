...
const ROUTES = {
  memphis: ['memphistn.gov', 'www.shelbycountytn.gov'],
  kitchener: ['www.kitchener.ca', 'www.canada.ca'],
  montreal: ['montreal.ca', 'www.canada.ca'],
  hamilton: ['www.hamilton.ca', 'www.canada.ca'],
  'san-francisco': ['www.sfgov.org', 'www.nps.gov'],
  'st-paul': ['www.stpaul.gov', 'www.mnhs.org'],
  victoria: ['www.victoria.ca', 'www.canada.ca'],
};
...
test('fourth GSC city wave adds official-source utility while provider inventory stays empty', async () => {
