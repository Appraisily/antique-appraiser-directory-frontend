...
const ROUTES = {
  arlington: ['www.arlingtontx.gov'],
  charlottetown: ['www.charlottetown.ca'],
  phoenix: ['www.phoenix.gov'],
  'quebec-city': ['www.ville.quebec.qc.ca'],
  whitehorse: ['www.whitehorse.ca'],
};
...
test('eighth GSC city wave clears the remaining utility deficits without publishing providers', async () => {
