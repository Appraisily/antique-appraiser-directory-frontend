...
const ROUTES = {
  moncton: ['www.moncton.ca', 'www.canada.ca'],
  providence: ['www.providenceri.gov', 'riema.ri.gov'],
  'salt-lake-city': ['www.slc.gov'],
  charleston: ['gis.charleston-sc.gov', 'www.charleston-sc.gov'],
  'little-rock': ['littlerock.gov'],
  sudbury: ['www.greatersudbury.ca', 'www.canada.ca'],
  savannah: ['www.savannahga.gov'],
};
...
test('sixth GSC city wave adds official-source utility while provider inventory stays empty', async () => {
