    ...
    return {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": appraiser.name,
          "item": `https://antique-appraiser-directory.appraisily.com/appraiser/${appraiserId}`
        }
      ]
    };
  };
  ...
  return (
    <>
      <SEO
        ...
        canonicalUrl={`https://antique-appraiser-directory.appraisily.com/appraiser/${appraiserId}`}
      />
